const IconSafe = ({ className }) => {
  return (
    <svg
      // width and height are removed to be controlled by CSS classes
      viewBox="0 0 32 32"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={className} // Apply classes like "w-8 h-8 text-green-500" here
    >
      <path
        ...
        stroke="currentColor" // Changed from "#22C55E"
        strokeWidth="2"
        strokeLinecap="round"
